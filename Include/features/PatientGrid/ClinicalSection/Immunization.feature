...
Examples:
     ...
     |ISAACS, KRISTEN| ICD-9|THER ULTRASOUND OF HEART::00.02|01012021|Completed|     1    |  vaccination   |Immunization protects from disease|
...
Examples:
     |    Patient    |Source|            Vaccine             |  Date  |   Status|Lot_Number|Manufacture_Name|    Comment   | 
     |ISAACS, KRISTEN| CVX  |influenza, live, intranasal::111|03172021|Completed|     15   |Medicine company|comments added|
