...
Scenario Outline: Add in medication with all fields
 ...
 Examples:
     ...
     |ISAACS, KRISTEN|    MMSL   |Humulin R U-500 KwikPen 500unit/ml Solution for Injection::100034|3 times a day|Auricular (otic)| 12102020 |   test, test      | Yes| Yes |     Yes      |As per the doctor recommend|
...
#		And I should see the newly added <Source_Type> and <Name> and <Frequency> and <Route> and <Start_Date> and <CPOE> and <eSent> and <Drug_Formulacy> and <Directions> medication on grid
 ...
 Examples:
     |    Patient    |Source_Type|              Name                 |  Frequency  |Route |Start_Date|Prescribed_By|CPOE|eSent|Drug_Formulacy|              Directions             |
     |ISAACS, KRISTEN|    HPC    |Advanced life support mileag::A0390|Every 8 hours|Dental| 03172021 |Test2, Test2 | Yes|  No |      No      |Edit directions in case of medication|
