...
Background: 
  ...
  Given I search <Patient> using global search
    ...
    *   I click on procedure result Update button
    ...
    |ISAACS, KRISTEN| ICD9 |THER ULT HEAD & NECK VES::00.01|03112021|Bone structure of tarsus (body structure) :: 108371006|Active|Accidental needle stick injury (disorder)::1.0850741e+16|Procedure Results Added  |
...
#		 And I should see the newly added <Source> and <Procedure> and <Date> and <Target_Site> and <Status> and <Reason> and <Service_Delivery_Location> procedure result on grid
     ...
     Examples:
    |    Patient    |Source|            Procedure              |  Date  |                 Target_Site                   |  Status |                          Reason                           |Service_Delivery_Location|
    |ISAACS, KRISTEN|  HPC |Noninterest escort in non er::A0080|01012021|Abnormal hematopoietic cell (cell) :: 107677004|Active   |Breast cancer screening declined (situation)::1.2275351e+16| Procedure Results Edited|
