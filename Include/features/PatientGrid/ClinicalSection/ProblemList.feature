...
Scenario Outline: Add in problem with all fields
 ...
 Examples:
    ...
    |ISAACS, KRISTEN| Cholera due to Vibrio cholerae 01, biovar cholerae::A00.0| 01072021   | Moderate |Condition| Active| Principal|
...
Scenario Outline: Edit in problem with all fields
 ...
 Examples:
    |    Patient    |        Code_Name          | Start_Date |Severity|   Type  | Status|   Rank   |
    |ISAACS, KRISTEN|Cholera, unspecified::A00.9| 03082021   | Severe |Diagnosis| Active| Secondary|
...
#	  And I should see the deleted problem not present on grid
 ...
 Examples:
    ...
    |ISAACS, KRISTEN|Cholera, unspecified::A00.9|
