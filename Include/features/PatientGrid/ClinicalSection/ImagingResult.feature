...
Background: 
   ...
   Given I search <Patient> using global search
     ...
     *   I click on imaging results Save button
     ...
     |ISAACS, KRISTEN|      HPC          |Outside state ambulance serv::A0021|02012021 21:38|Latif, Zohaib |Active|C:\Users\muhammad.zohaib\ImageResultfile.docx|passed |    Patient   |
...
#		 And I should see the newly added imaging results record <Imaging_Test_Type> and <Date> and <Order_Provider> and <Status> and <File> present on grid
     ...
     |ISAACS, KRISTEN|      LOINC      |Amdinocillin Islt KB::1-Sep|02012021 21:38|Latif, Zohaib |Active   |C:\Users\muhammad.zohaib\ImageResultfile.docx|Edit result |better condition|   
