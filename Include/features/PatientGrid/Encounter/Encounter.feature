...
# no data show against it		*   I enter <Disfacility> in patient encounter dis facility field
...
#		And I should see the newly created encounter on grid
    ...
    |ISAACS, KRISTEN |  C4  |  Yes   |Observation care, typically 30 minutes are spent::99218|12192020 01:30:00 AM|12072021 01:30:00 AM|Support Test Fac|    SNF    |    SNF 1    |pakistan|Allergy clinic|Telehealth|Referral Note|Latif, Zohaib|   test, test   |    A JAFFER    |   
...
#		And I should see the newly created encounter on grid
    ...
    Examples:
    |    Patient     |Source|Billable|                          Encounter                    |      StartDate     |       EndDate      |ServingFacility |  Disposition| Disfacility |Location|      POS     | VisitType|   NoteType  | ApptProvider|RendringProvider|RefrenceProvider|   
    |ISAACS, KRISTEN |  C4  |  Yes   |Observation care, typically 30 minutes are spent::99218|12192020 01:30:00 AM|12072021 01:30:00 AM|Support Test Fac|     SNF     |     SNF 2   |pakistan|Allergy clinic|Telehealth|Referral Note|Latif, Zohaib|   test, test   |    A JAFFER    |   
...
#		And I should see deleted encounter not present on grid
    ...
    Examples:
    |    Patient     |                       Encounter                       |
    |ISAACS, KRISTEN |Observation care, typically 30 minutes are spent::99218|
