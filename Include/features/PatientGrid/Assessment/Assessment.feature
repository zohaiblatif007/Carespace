...
Feature: Add All types of Assessments
  ...
  Given I search <Patient> using global search
   ...
   Then I should see success message for added assessment
    ...
    Examples: 
      ...
      | BLANZENSKI, KAREN | HTN   |     Yes      |      893 | chronic disease  |Yes |Most of the time|All of the time | No |Yes |
  ...
  Given I search <Patient> using global search
   ...
   When I click on Assessment Add button
    ...
    Examples: 
      ...
      | BLANZENSKI, KAREN | HTN-1 |     Yes      |      893 | chronic desease  |
  ...
  Given I search <Patient> using global search
   ...
   Then I should see success message for added assessment
    ...
    Examples: 
      ...
      | BLANZENSKI, KAREN|   Asthma     |Asthma Assessment-2|  689  |Asthma assessment|  Some of the time | Most of the time| Moderate| None of the time | A little of the time|     Yes     | 
  ...
  Given I search <Patient> using global search
   ...
   Then I should see success message for added assessment
    ...
    Examples: 
      |     Patient      | B_Assessment|             Title            |CPTCode|     Comment     |        Ans1       |      Ans2       |   Ans3  |      Ans4        |        Ans5         | BillableType|
      | BLANZENSKI, KAREN|   Asthma    |Asthma Assessment-nonbillable |       |Asthma assessment|  Some of the time | Most of the time| Moderate| None of the time | A little of the time|     No      | 
  ...
  Given I search <Patient> using global search
   ...
   Then I should see success message for added assessment
    ...
    Examples: 
      |     Patient      | Title            | BillableType | CPTCode  | Comment   |
      | BLANZENSKI, KAREN| Covid Assessment |     Yes      | 789      | DO KIDS NEED A COVID-19 VACCINE? Yes CAN ANTIBODY TESTS SHOW IF A COVID-19 VACCINE IS WORKING? Yes IF I’VE HAD COVID-19, DO I REALLY NEED THE VACCINE? No DO WE NEED BOOSTER DOSES? Yes DO COVID-19 VACCINES AFFECT FERTILITY OR PERIODS? Yes|
 ...
 @AddBasedonPreviousmAssessment 
  ...
  Given I search <Patient> using global search
   ...
   Then I should see success message for added assessment
    ...
    Examples: 
      |     Patient      | Title            | BillableType | CPTCode  | Comment   |
      | BLANZENSKI, KAREN| Covid Assessment-3 |     Yes      | 758    | Take Steam dailly|
