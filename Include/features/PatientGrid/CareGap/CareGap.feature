...
Given I search <Patient> using global search
  ...
  *   I click on patient task tab in main menu
  ...
  |JURCEC, LILLIAN|TCM interactive contact|do jim every day|03202021 04:54 AM|04202021 04:54 AM|In Progress|Task created from caregap|
  ...
  *   I click on patient task tab in main menu
  And I should see task <Taskname> with status <Status> and start date <Strtdate> end date <Completeddate> present in task section
    ...
    Examples: 
      ...
      | JURCEC, LILLIAN|TCM interactive contact| Task created | 03202021 04:54 AM | 04202021 04:54 AM | In Progress | Task created from caregap | Daily      |    3 |         4 |
  ...
  *   I click on patient task tab in main menu
  And I should see task <Taskname> with status <Status> and start date <Strtdate> end date <Completeddate> present in task section
    ...
    Examples: 
      ...
      |JURCEC, LILLIAN|TCM interactive contact| Task created | 03202021 04:54 AM | 04202021 04:54 AM | In Progress | Task created from caregap | Weekly     |     3 |         4 |
  ...
  *   I click on patient task tab in main menu
  And I should see task <Taskname> with status <Status> and start date <Strtdate> end date <Completeddate> present in task section
    ...
    Examples: 
      ...
      |JURCEC, LILLIAN|TCM interactive contact| Task created | 03202021 04:54 AM | 04202021 04:54 AM | In Progress | Task created from caregap | Monthly    |     3 |         4 |
  ...
  *   I click on patient task tab in main menu
  And I should see task <Taskname> with status <Status> and start date <Strtdate> end date <Completeddate> present in task section
    ...
    Examples: 
      ...
      |JURCEC, LILLIAN|TCM interactive contact| Task created | 03202021 04:54 AM | 04202021 04:54 AM | In Progress | Task created from caregap | Yearly     |    3 |         4 |
 ...
 #Then I should see success message for deleted goal and task
    ...
    Examples: 
      ...
      |JURCEC, LILLIAN|TCM interactive contact| Goal is to cure in a week | ST             |     04012021 |    04222021 | Normal Priority | Provider  | Goal has created | Blood pressure |      03122021 |   4122021 | High         | Active     | Goal and Task Created by gaol and task |
...
Given I search <Patient> using global search
 ...
 #Then I should see success message for deleted PWB goal
    ...
    Examples: 
      ...
      |JURCEC, LILLIAN|TCM interactive contact| Goal is to cure in a week | ST             |     04022021 |    04222021 | Normal Priority | Provider  | Goal has created |
  ...
  Scenario Outline: Create task of a patient
    ...
    *   I click on yes button to cofirm delete goal task
    ...
    Examples: 
      ...
      |JURCEC, LILLIAN| Blood pressure |TCM interactive contact|   08102021    |   12312021 | High         | Active     | Task Created by gaol and task |
  ...
  Scenario Outline: validate the data of a care gap
    ...
    Examples: 
      | Patient       |    Care_Gap                            |
      |JURCEC, LILLIAN| TCM interactive contact|
  ...
  Scenario Outline: status change to closed of an open care gap
    ...
    * I click on update button to save status of care gap
    ...
    Examples: 
      ...
      |JURCEC, LILLIAN|TCM interactive contact| Open  | Follow up with patient |              |
      |JURCEC, LILLIAN|TCM interactive contact|Closed | Follow up with patient | Goal Created |
      |JURCEC, LILLIAN|TCM interactive contact| Open  | Follow up with patient |              |
  ...
  Scenario Outline: status change to closed of an open care gap with cross button
    ...
    * I click on save button to close care gap
    ...
    Examples: 
      ...
      |JURCEC, LILLIAN|TCM interactive contact|Closed |Goal Created|
