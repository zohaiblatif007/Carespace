...
//		}
	...
	def Veryfiyingemailnotset() {
		...
		WebUI.waitForElementClickable(findTestObject('Object Repository/OR_PatientGrid/OR_PatientData/OR_PatientdemographicRecord/Obj_Alertsendinvitefailed'), GlobalVariable.timeout)
