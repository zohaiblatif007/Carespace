...
class ProblemListsteps {
	...
	def I_click_on_delete_button(String Problem_Name) {
		...
		List<WebElement> Table1=	driver.findElements(By.xpath("//div[@data-mz-key='clinical.problem']//span[@title='Source: Persivia']//parent::td//parent::tr//td[3]"))
		...
		for( ;i<=s1;i++) {
			String xpathd1 = "(//div[@data-mz-key='clinical.problem']//span[@title='Source: Persivia']//parent::td//parent::tr)["+i+  "]//td[3]"
		...
		String xpathd2 = "(//div[@data-mz-key='clinical.problem']//span[@title='Source: Persivia']//parent::td//parent::tr)["+i+  "]//td[12]//button"
	...
	def user_set_rank_by_drop_down(String Rank) {
		...
		TestObject t4 = new TestObject('Rank')
...
//				findTestData('DF_CMRData/DF_ClinicalSection/TD_ADDProblemList').getValue(7, 1))
	...
	def very_deleted_data_should_benot_visible_on_the_UI(){
		...
		//WebElement Table = driver.findElement(By.xpath("(//div[@data-mz-key='clinical.problem']//table)[2]//tbody"))
		List<WebElement> Table2=	driver.findElements(By.xpath("//div[@data-mz-key='clinical.problem']//span[@title='Source: Persivia']//parent::td//parent::tr//td[3]"))
